...
const RepeatableTwoTextInputFields = ({
  formData = {},
  labelText = "",
  fieldId = "",
  lableStatus = false,
                  ...
                  >
                    <div className="flex flex-col gap-3 w-full">
                      ...
                      <Input
                        ...
                        placeholder={firstInputFieldPlaceholder}
                      ...
                      <Input
                        ...
                        placeholder={secondInputFieldPlaceholder}
                        className="w-full border border-[#000]/20 font-poppins-rg text-[13px] text-light-weight-400 focus-visible:outline-none focus-visible:ring-0 dark:border-[#fff]/10 dark:bg-[#000]/10 dark:text-light-weight-400"
                      />
                    </div>
...
export default RepeatableTwoTextInputFields;
